...
public class Queen extends Pieces {
    ...
    public List<Move> getPossibleMoves(Tile[][] boardField, List<Move> enemyMoves) {
        ...
        diagonalLeftLowerTilePossibleMoves(boardField, possibleMoves);
        diagonalLeftUpperTilePossibleMoves(boardField, possibleMoves);
        diagonalRightLowerTilePossibleMoves(boardField, possibleMoves);
        diagonalRightUpperTilePossibleMoves(boardField, possibleMoves);
    ...
    public boolean hasAlreadyMoved() {
        LOGGER.warning("The method hasAlreadyMoved called for Queen");
        return true;
    }
    ...
    public void setStatusToHasMoved() {
        LOGGER.warning("The method setStatusToHasMoves called for Queen");
    }
